...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let someObj = SomeStruct(time: "12:22", places: "1-2-3", runners: "7", mapDescriptuon: "John Kaye Building & Construction Amateur Riders' Handicap, Class: 5, Distance: 2 mile, 5 furlong", mapImage: UIImage(named: "Bitmap"), raceDescription: "Samuel Drinkwater's well-handicapped 8yo BILLY HICKS rediscovered some form when second in today's headgear combination at Ludlow three weeks ago, and could be seen to even better effect if the ground softens here...")
